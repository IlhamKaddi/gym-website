  ...
  return (
    <section className="relative min-h-screen overflow-hidden py-12">
      ...
      <div className="relative z-10 flex flex-col md:flex-row min-h-screen">
        {/* MAP SECTION */}
        <div className="w-full md:w-[60%] relative min-h-[400px] md:min-h-screen aspect-[16/9] md:aspect-auto">
          ...
          <div className="absolute bottom-8 right-8">
            <a
              ...
              className="flex items-center gap-3 bg-[#EB1C22] text-white px-4 py-2 md:px-6 md:py-4 rounded-full shadow-2xl hover:shadow-[#EB1C22]/50 hover:scale-105 transition-all duration-300 font-semibold"
            >
